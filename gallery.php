...
<head>
    <title>Health Care : Gallery</title>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="gallery-area">
                    ...
                    <div class="my-simple-gallery">
                        ...
                        <div class="row">
                            <figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                <a class="gallery-iteam" href="images/gallery/cb-SK-clinics.jpg" itemprop="contentUrl" data-size="1024x1024">
                                    <img src="images/gallery/cb-SK-clinics.jpg" itemprop="thumbnail" alt="Image description" />
                                    <span class="image-effect"></span>
                                </a>
                            </figure>
                            <figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                <a class="gallery-iteam" href="images/gallery/cb-SK-resources.jpg" itemprop="contentUrl" data-size="1024x1024">
                                    <img src="images/gallery/cb-SK-resources.jpg" itemprop="thumbnail" alt="Image description" />
                                    <span class="image-effect"></span>
                                </a>
                            </figure>
                            <figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
