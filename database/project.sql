...
(2, 'admin@gmail.com', '123458976', '1234');
...
(1, 'Piyushh Bhutoria', 'email@gmail.com', '2017-06-30', 'Male', 'anything.', '123458976', '1234', 'clientdp/7729_Jason_Bradburyglass.jpg'),
(8, 'Piyush Bhutoria', 'piyush.bhutoria123@gmail.com', '1998-12-12', 'Male', '152/6 hardutt Rai Chamaria', '0123458976', '1234', NULL);
...
(1, 'Ross Gellar', 'ross@gmail.com', '2017-07-01', 'Male', 'F.R.I.E.N.D.S.', '123458976', '1234', 500, 'Paleantologist', 'docdp/7729_Jason_Bradburyglass.jpg'),
(4, 'Piyush Bhutoria', 'healthcare@gmail.com', '1998-12-12', 'Male', '152/6 hardutt Rai Chamaria, A Block', '0123458976', '123456', 500, 'dentist', NULL);
...
--
-- Table structure for table `test_Health Care`
--

CREATE TABLE `test_Health Care` (
  `Id` int(11) NOT NULL,
...
--
-- Dumping data for table `test_Health Care`
--

INSERT INTO `test_Health Care` (`Id`, `Test_id`, `Test_time`, `Test_date`, `Users_id`, `Report`) VALUES
...
--
-- Indexes for table `test_Health Care`
--
ALTER TABLE `test_Health Care`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `Users_id` (`Users_id`),
...
--
-- AUTO_INCREMENT for table `test_Health Care`
--
ALTER TABLE `test_Health Care`
...
--
-- Constraints for table `test_Health Care`
--
ALTER TABLE `test_Health Care`
  ADD CONSTRAINT `test_Health Care_ibfk_1` FOREIGN KEY (`Users_id`) REFERENCES `client` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `test_Health Care_ibfk_2` FOREIGN KEY (`Test_id`) REFERENCES `test` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
